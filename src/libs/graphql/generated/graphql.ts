...
export type GetAnimeDataQueryVariables = Exact<{
  page?: InputMaybe<Scalars['Int']['input']>;
  id?: InputMaybe<Scalars['Int']['input']>;
  type?: InputMaybe<MediaType>;
  isAdult?: InputMaybe<Scalars['Boolean']['input']>;
...
export type GetAnimeDataQuery = { __typename?: 'Query', Page?: { __typename?: 'Page', pageInfo?: { __typename?: 'PageInfo', hasNextPage?: boolean | null } | null, media?: Array<{ __typename?: 'Media', id: number, isAdult?: boolean | null, seasonYear?: number | null, format?: MediaFormat | null, averageScore?: number | null, title?: { __typename?: 'MediaTitle', english?: string | null, native?: string | null, romaji?: string | null } | null, coverImage?: { __typename?: 'MediaCoverImage', color?: string | null, large?: string | null } | null, tags?: Array<{ __typename?: 'MediaTag', category?: string | null, description?: string | null, isAdult?: boolean | null, rank?: number | null, name: string } | null> | null } | null> | null } | null };


export const GetAnimeDataDocument = gql`
    query GetAnimeData($page: Int = 1, $id: Int, $type: MediaType, $isAdult: Boolean = false, $search: String, $format: [MediaFormat], $status: MediaStatus, $countryOfOrigin: CountryCode, $source: MediaSource, $season: MediaSeason, $seasonYear: Int, $year: String, $onList: Boolean, $yearLesser: FuzzyDateInt, $yearGreater: FuzzyDateInt, $episodeLesser: Int, $episodeGreater: Int, $durationLesser: Int, $durationGreater: Int, $chapterLesser: Int, $chapterGreater: Int, $volumeLesser: Int, $volumeGreater: Int, $licensedBy: [Int], $isLicensed: Boolean, $genres: [String], $excludedGenres: [String], $tags: [String], $excludedTags: [String], $minimumTagRank: Int, $sort: [MediaSort] = [POPULARITY_DESC, SCORE_DESC], $genre: String, $averageScore: Int, $tagCategory: String, $tag: String) {
...
/**
 * __useGetAnimeDataQuery__
 *
 * To run a query within a React component, call `useGetAnimeDataQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetAnimeDataQuery` returns an object from Apollo Client that contains loading, error, and data properties
 ...
 *      averageScore: // value for 'averageScore'
 *      tagCategory: // value for 'tagCategory'
 *      tag: // value for 'tag'
 *   },
 * });
 */
export function useGetAnimeDataQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<GetAnimeDataQuery, GetAnimeDataQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return ApolloReactHooks.useQuery<GetAnimeDataQuery, GetAnimeDataQueryVariables>(GetAnimeDataDocument, options);
      }
export function useGetAnimeDataLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<GetAnimeDataQuery, GetAnimeDataQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return ApolloReactHooks.useLazyQuery<GetAnimeDataQuery, GetAnimeDataQueryVariables>(GetAnimeDataDocument, options);
        }
export function useGetAnimeDataSuspenseQuery(baseOptions?: ApolloReactHooks.SkipToken | ApolloReactHooks.SuspenseQueryHookOptions<GetAnimeDataQuery, GetAnimeDataQueryVariables>) {
          const options = baseOptions === ApolloReactHooks.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return ApolloReactHooks.useSuspenseQuery<GetAnimeDataQuery, GetAnimeDataQueryVariables>(GetAnimeDataDocument, options);
        }
export type GetAnimeDataQueryHookResult = ReturnType<typeof useGetAnimeDataQuery>;
export type GetAnimeDataLazyQueryHookResult = ReturnType<typeof useGetAnimeDataLazyQuery>;
export type GetAnimeDataSuspenseQueryHookResult = ReturnType<typeof useGetAnimeDataSuspenseQuery>;
export type GetAnimeDataQueryResult = ApolloReactCommon.QueryResult<GetAnimeDataQuery, GetAnimeDataQueryVariables>;